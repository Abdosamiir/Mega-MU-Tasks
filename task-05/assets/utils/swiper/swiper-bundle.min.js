...
var Swiper = (function () {
  ...
  const D = (e, t) => {
      ...
      if (s) {
        let t = s.querySelector(`.${e.params.lazyspinnerClass}`);
        !t &&
          e.isElement &&
          (s.shadowRoot
            ? (t = s.shadowRoot.querySelector(`.${e.params.lazyspinnerClass}`))
            : requestAnimationFrame(() => {
                s.shadowRoot &&
                  ((t = s.shadowRoot.querySelector(
                    `.${e.params.lazyspinnerClass}`
                  )),
                  t && t.remove());
              })),
          t && t.remove();
  ...
  var ee = {
    ...
    lazyspinnerClass: "swiper-lazy-spinner",
